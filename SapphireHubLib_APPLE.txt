--[[
    ...
    Github: https://github.com/Footagesus/Apple
...
warn("[ Apple: DEBUG Mode ] "..j)

return g.Apple:Notify{
...
local t="Apple/"..o.."/Assets/."..p.."-"..k..".png"
...
if not u then
warn("[ Apple.Creator ]  '"..identifyexecutor().."' doesnt support the URL Images. Error: "..v)
...
local n=a.load'e'.Init(nil,i.Apple.ScreenGui.KeySystem)
...
local i=a.load'e'.Init(nil,g.Apple.ScreenGui.Popups)
...
ImageTransparency=o.Transparent and o.Apple.TransparencyValue or 0,
},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
...
p.Transparent=L
o.Apple.Transparent=L

p.UIElements.Main.Background.ImageTransparency=L and o.Apple.TransparencyValue or 0
...
o.Apple.UIScale=L
g(o.Apple.ScreenGui.UIScale,.2,{Scale=L},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
end
...
local K=a.load'A'
local L=a.load'B'
local M=K.Init(p,o.Apple,o.Parent.Parent.ToolTips)
...
return L.New(O,p.UIElements.SideBar.Frame,p.Folder,o.Apple.UIScale)
end
